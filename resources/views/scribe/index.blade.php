    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-products-import">POST api/products/import</a>
                            </li>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;success&quot;: false,
    &quot;message&quot;: &quot;SQLSTATE[HY000] [2002] php_network_getaddresses: getaddrinfo for db failed: Name or service not known (Connection: mysql, Host: db, Port: 3306, Database: laravel, SQL: select * from `products` where `active` = 1 and `is_new` = 1 and `sku` = P00010 and `video_url` is not null limit 1)&quot;
}</code>
 </pre>
    </span>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;success&quot;: false,
    &quot;message&quot;: &quot;SQLSTATE[HY000] [2002] php_network_getaddresses: getaddrinfo for db failed: Name or service not known (Connection: mysql, Host: db, Port: 3306, Database: laravel, SQL: select * from `products` where `id` = 16 limit 1)&quot;
}</code>
 </pre>
    </span>
...
<div class="bash-example">
    ...
    \"is_offer\": false,
    \"offer_percentage\": 1,
    \"offer_start_date\": \"2026-02-19T17:04:29\",
    \"offer_end_date\": \"2052-03-14\",
    \"release_date\": \"2026-02-19T17:04:29\",
    \"active\": true,
    \"featured\": true,
    \"tag_ids\": [
        16
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-02-19T17:04:29"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-19T17:04:29</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/checkout" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-products-import">POST api/products/import</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "file=@/tmp/phpixBL1x" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must not be greater than 5120 kilobytes. Example: <code>/tmp/phpixBL1x</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/products/16/comments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"rating\": 1,
