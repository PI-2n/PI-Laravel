...
<div class="header_btn-container">
    <div class="platform-btn-container">
        ...
        <a href="#"><img src="{{ asset('images/icons/switch.png') }}" alt="Nintendo Switch"
                class="platform-btn" /></a>
    ...
    <div class="user-btn-container">
        ...
        @endauth
        <a href="{{ route('cart.index') }}" class="cart-btn-wrapper"
